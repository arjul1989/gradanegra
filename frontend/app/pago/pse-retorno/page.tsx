...
function PSEPaymentReturnContent() {
  ...
  useEffect(() => {
    const handlePaymentReturn = async () => {
      try {
        ...
        console.error('Error al procesar retorno de PSE:', error);
        setPaymentStatus({
          status: 'error',
  ...
  const getStatusMessage = (status: string) => {
    switch (status) {
      case 'approved':
      case 'aprobado':
        return '¡Pago PSE aprobado exitosamente!';
      case 'rejected':
      case 'rechazado':
        return 'Pago PSE rechazado';
      case 'pending':
      case 'pendiente':
        return 'Pago PSE en proceso de verificación';
      default:
        return 'Estado del pago PSE';
    }
  };
    ...
    return (
      <div className="min-h-screen bg-slate-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white">Procesando retorno del pago PSE...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="bg-slate-800 rounded-lg p-4 mb-6 text-left">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-white">PSE (Transferencia Bancaria)</span>
              </div>
            </div>
          </div>
          ...
          {paymentStatus?.status === 'pending' && (
            <div className="bg-blue-900/20 border border-blue-500/50 rounded-lg p-4 mb-6">
              ...
              <p className="text-sm text-blue-200">
                Los pagos PSE pueden tardar entre 5 minutos a 24 horas en confirmarse. 
          ...
          {paymentStatus?.status === 'approved' && (
            <div className="bg-green-900/20 border border-green-500/50 rounded-lg p-4 mb-6">
              ...
              <p className="text-sm text-green-200">
                Tu compra ha sido procesada exitosamente. Recibirás tus tickets por email en los próximos minutos.
              </p>
            </div>
          )}
          ...
          {paymentStatus?.status === 'rejected' && (
            <div className="bg-red-900/20 border border-red-500/50 rounded-lg p-4 mb-6">
              ...
              <p className="text-sm text-red-200">
                El pago fue rechazado por el banco. Por favor verifica tu cuenta e intenta nuevamente, 
...
export default function PSEPaymentReturn() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-slate-950 flex items-center justify-center">
        <div className="text-center">
